  ...
  const displayTabContent = () => {
    switch (activeTab) {
      ...
      case "Responsibilities":
        return <Specifics title="Qualifications" points={data[0].job_highlights?.Responsibilities ?? ["N/A"]} />;
        break;
    }
  };
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.lightWhite }}>
      ...
      <JobFooter url={data[0]?.job_google_link ?? "https://careers.google.com/jobs/job/results"} />
    </SafeAreaView>
  );
};
